#
#  Be sure to run `pod spec lint mecab-naist-jdic-utf-8.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Jamie Birch"
  # spec.authors            = { "Jamie Birch" => "14055146+shirakaba@users.noreply.github.com" }
  # spec.social_media_url   = "https://twitter.com/Jamie Birch"
